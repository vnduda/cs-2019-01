...
public class TransformaExtensoTest {
    ...
    public void CasosClassicos() {
        ...
        assertEquals(" dois mil duzentos e vinte e dois", var.recuperaString(teste1));
        assertEquals(" três mil trezentos e trinta e três", var.recuperaString(teste2));
        assertEquals(" quatro mil quatrocentos e quarenta e quatro", var.recuperaString(teste3));
        assertEquals(" cinco mil quinhentos e cinquenta e cinco", var.recuperaString(teste4));
        assertEquals(" seis mil seissentos e sessenta e seis", var.recuperaString(teste5));
        assertEquals(" sete mil setecentos e setenta e sete", var.recuperaString(teste6));
        assertEquals(" oito mil oitocentos e oitenta e oito", var.recuperaString(teste7));
        assertEquals(" nove mil novecentos e noventa e nove", var.recuperaString(teste8));
    }
